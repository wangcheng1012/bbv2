...
public class AnLi extends BaseRefreshFragment{
	...
	protected void initCommonAdapter(List<Base> listDate2) {
		...
		lv_center.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				if(!"55f2774bd812a81087eb9e24".equals(mc.getId())){
					
					Intent xiangqing = new Intent(mContext, AnLiList.class);
					...
					((Home2)getParentFragment()).ShowSearchPopupWindow(R.id.anlisearch);
				}
			}
		});
	...
	private void topsearch(){
		...
		ExecutorServices.getExecutorService().execute(new Runnable() {
			...
			public void run() {
				...
				map.put("id", "55f2774bd812a81087eb9e24");
				map.put("bujiami", "");
	...
	protected BaseList webMethod(Context mContext, Bundle bundle,
		...
		map.put("fenleiid", "55f29682d812a8284be70ade");
		map.put("bujiami", "");
